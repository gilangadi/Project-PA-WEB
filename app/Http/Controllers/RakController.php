...
class RakController extends Controller
{
    public function indexdipinjam(){
        $create = Rak::latest()->where('status_buku_jurnal','dipinjam')->get();
       return response([
           'success' => true,
   ...
   public function indextersedia(){
    $create = Rak::latest()->where('status_buku_jurnal','tersedia')->get();
   return response([
       'success' => true,
       'message' => 'List Semua Jurnal',
       'data' => $create
...
//
    public function indexjurnal(){
         $create = Rak::latest()->where('status','jurnal')->get();
        return response([
            'success' => true,
            'message' => 'List Semua Jurnal',
            'data' => $create
    ...
    public function indexbuku(){
        $create = Rak::latest()->where('status','buku')->get();
       return response([
           'success' => true,
   ...
   return response()->json($out, 200);
    ...
    {        
        return response()->json(Rak::all());
    }

    public function showOneJurnal($id)
    {
        return response()->json(Rak::find($id));
    }
    ...
    public function create(Request $request){
        ...
        if ($create){
            ...
            //  $create ["status"] => TRUE,
            //  $create ["pesan"] = "Berhasil tambah data",
